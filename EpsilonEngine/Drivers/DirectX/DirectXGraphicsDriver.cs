...
namespace EpsilonEngine.Drivers.DirectX
{
    ...
    {
        public DirectXGraphicsDriver(GameInterface gInterface) : base(gInterface)
        {
            /*
            // input and output files are supposed to be in the program folder
            var inputPath = @"D:\Photos\0.png";
            var outputPath = @"D:\Test.png";

            // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            // INITIALIZATION ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

            // initialize the D3D device which will allow to render to image any graphics - 3D or 2D
            var defaultDevice = new SharpDX.Direct3D11.Device(SharpDX.Direct3D.DriverType.Hardware, d3d.DeviceCreationFlags.BgraSupport); // take out the Debug flag for better performance
            ...
            var textFormat = new dw.TextFormat(dwFactory, "Arial", 50f); // create the text format of specified font configuration
            ...
            var textBrush = new d2.SolidColorBrush(d2dContext, new SharpDX.Mathematics.Interop.RawColor4(1, 1, 1, 1));
            ...
            d2dContext.DrawTextLayout(new SharpDX.Mathematics.Interop.RawVector2(5, 5), textLayout, textBrush);
            d2dContext.EndDraw();
